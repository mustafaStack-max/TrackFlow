...
export default function ConcentrationWidget({ data = null }) {
    ...
    <div className="flex flex-col gap-5">
      ...
      >
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          <div>
            <div
              className={`${F.mono} text-[0.58rem] tracking-[2px] mb-1`}
              style={{ color: C.t4 }}
            >
              STATUS · FOCUS LEVEL
            </div>
            ...
            <div className="flex items-center gap-2">
              <span
                className={`${F.ar} text-[1rem] font-bold`}
          ...
          <div
            className={`${F.mono} text-[0.6rem] text-left shrink-0`}
            style={{ color: C.t3 }}
          >
        ...
        <div
          className={`${F.ar} text-[0.72rem] mt-3 leading-relaxed`}
          style={{ color: C.t2 }}
        >
          {cfg.desc}
        </div>
      ...
      <div className="flex flex-col gap-2.5">
        <div
          className={`${F.mono} text-[0.6rem] tracking-[2px]`}
          style={{ color: C.t4 }}
        >
        ...
        {top3.map((cat, idx) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              >
                <span>
                  <span dir="ltr">{cat.pct.toFixed(1)}%</span> من الإجمالي
                </span>
                <span>·</span>
        ...
        {otherShare > 0 && (
          ...
          >
            ...
            <div
              className="w-1 h-10 rounded-full shrink-0"
              style={{ background: `${C.t4}40` }}
            />

            <div className="flex-1 min-w-0">
              <div className="flex items-baseline justify-between gap-2">
                <span
                  className={`${F.ar} text-[0.8rem] font-semibold truncate`}
                  style={{ color: C.t3 }}
                >
                ...
                <span
                  className={`${F.mono} text-[0.85rem] font-bold`}
                  style={{ color: C.t3 }}
                >
